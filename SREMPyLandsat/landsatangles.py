...
def makeAnglesImage(templateimg, outfile, nadirLine, extentSunAngles, satAzimuth, imgInfo):
    ...
    #makeAngles(imgInfo, infiles, outfiles, otherargs)
...
def makeAngles_(mtlfile, templateimg, outfile):
    """
    ...
    imgInfo = fileinfo.ImageInfo(templateimg)
    corners = findImgCorners(templateimg, imgInfo)
    nadirLine = findNadirLine(corners)

    extentSunAngles = sunAnglesForExtent(imgInfo, mtlInfo)
    satAzimuth = satAzLeftRight(nadirLine)

    makeAnglesImage(templateimg, outfile, nadirLine, extentSunAngles, satAzimuth, imgInfo)